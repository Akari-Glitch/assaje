...
function PrivacyPolicy() {
    return (
        <>
            <PolicyStyles>
                <h1 className="extra-middle">PRIVACY POLICY</h1>

                <p className="middle">Gentile Utente, ti ringraziamo per aver visitato il nostro sito.<br />
                    Nel prosieguo della pagina ti descriviamo le modalità di gestione del sito in riferimento al trattamento dei dati personali degli utenti che lo consultano.</p>
                <p className="middle"><strong>PERCHÈ QUESTO AVVISO<br />
                </strong><br />
                    Si tratta di un’informativa resa anche ai sensi dell’art. 13 del D.lgs. n. 196/03 (Codice in materia di protezione dei dati personali) e art. 13 e 14 del Regolamento Europeo 679/2016 (di seguito anche “GDPR”) a coloro che interagiscono con i servizi web direttamente forniti dalla Società.<br />
                    L’informativa è resa per il presente sito e non anche per altri siti web eventualmente consultati dall’utente tramite link. L’informativa si ispira alla raccomandazione n. 2/2001 che le autorità europee per la protezione dei dati personali, riunite nel Gruppo istituito dall’art. 29 della direttiva n. 95/46/CE, hanno adottato il 17 maggio 2001 per individuare alcuni requisiti minimi per la raccolta di dati personali on-line, e, in particolare, le modalità, i tempi e la natura delle informazioni che i titolari del trattamento devono fornire agli utenti quando questi si collegano a pagine web, indipendentemente dagli scopi del collegamento. Ti invitiamo quindi a prendere visione della nostra Politica di Privacy, di seguito illustrata.<br />
                    La Politica e gli Standard di Privacy utilizzati per la protezione dei dati personali sono fondati sui seguenti principi:</p>
                <p className="middle"><strong>Titolare del Trattamento<br />
                </strong><br />
                    Il titolare del trattamento dati è Assaje Srl (Partita IVA 08526381218 – <a href="mailto:amministrazione@assaje.it">amministrazione@assaje.it</a>), di seguito la Società.</p>
                <p className="middle"><strong>PRINCIPIO DI RESPONSABILITÀ<br />
                </strong><br />
                    Il trattamento di dati personali è gestito nel tempo da responsabili individuati all’interno dell’organizzazione aziendale.</p>
                <p className="middle"><strong>PRINCIPIO DI TRASPARENZA<br />
                </strong><br />
                ...
                <p className="middle"><strong>PRINCIPIO DI PERTINENZA DELLA RACCOLTA<br />
                </strong><br />
                    I dati personali sono trattati in modo lecito e secondo correttezza; sono registrati per scopi determinati, espliciti e legittimi; sono pertinenti e non eccedenti le finalità del trattamento; sono conservati per il tempo necessario agli scopi della raccolta.</p>
                <p className="middle"><strong>PRINCIPIO DI FINALITÀ DELL’UTILIZZO<br />
                </strong><br />
                ...
                <p className="middle"><strong>PRINCIPIO DI VERIFICABILITÀ<br />
                </strong><br />
                ...
                <p className="middle"><strong>PRINCIPIO DI SICUREZZA<br />
                </strong><br />
                    I dati personali sono protetti da misure di sicurezza tecniche, informatiche, organizzative, logistiche e procedurali, contro i rischi di distruzione o perdita, anche accidentale, e di accesso non autorizzato o di trattamento non consentito.<br />
                    Tali misure sono aggiornate periodicamente in base al progresso tecnico, alla natura dei dati e alle specifiche caratteristiche del trattamento, controllate costantemente e verificate nel tempo. Le terze parti che svolgono attività di supporto di qualsiasi tipo per l’erogazione dei servizi richiesti da parte della Società, in relazione ai quali eseguono operazioni di trattamento di dati personali, sono da quest’ultime designate Responsabili del Trattamento e sono contrattualmente vincolate al rispetto delle misure per la sicurezza e la riservatezza dei trattamenti. L’identità di dette terze parti è resa nota agli utenti.<br />
                    La Società non si assume inoltre alcuna responsabilità su:</p>
                <ol>
                    <li className="middle">le regole e modalità di gestione dei dati personali di altri siti Web, raggiungibili dalle nostre pagine attraverso collegamenti e rimandi;</li>
                    <li className="middle">i contenuti di eventuali servizi di e-mail, spazi Web, chat forum forniti agli utenti.</li>
                </ol>
                <p className="middle">I trattamenti connessi ai servizi web offerti da questo sito hanno luogo presso la Società, ed eventualmente presso le sedi dei Responsabili del Trattamento e sono curati da incaricati del trattamento preposti alla gestione dei servizi richiesti, alle attività di marketing – ove richieste dall’utente – alle attività di conservazione dati e di occasionali operazioni di manutenzione.</p>
                <p className="middle"><strong>AMBITO DI COMUNICAZIONE DEI DATI<br />
                </strong><br />
                ...
                <p className="middle"><strong>DATI FORNITI VOLONTARIAMENTE DALL’UTENTE<br />
                </strong><br />
                ...
                <p className="middle"><strong>DATI DI NAVIGAZIONE<br />
                </strong><br />
